 ...
 * @author Nic
 */
public class JFNoClienteDepositar extends JFPadre {

    Metodos met = new Metodos();

    public JFNoClienteDepositar() {
        initComponents();
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        met.NuevoMovNoCliente(met.TomarFecha(), NC.getUsuario(), "DE", Integer.parseInt(this.txtMonto.getText()), Admin.getSaldoCajero());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFNoClienteDepositar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFNoClienteDepositar().setVisible(true);
            }
        });
    }
