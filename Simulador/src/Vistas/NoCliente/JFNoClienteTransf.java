...
import Clases.Persona.NoCliente;
import Metodos.Metodos;
import Vistas.JFPadre;
import java.awt.Color;

public class JFNoClienteTransf extends JFPadre {

     Metodos met = new Metodos();
    public JFNoClienteTransf() {
        initComponents();
        this.labelTexto.setText("TRANSFERIR");
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        NoCliente NC = new NoCliente();
        Admin admin = new Admin();
        JFNoCliente FNC = new JFNoCliente();

        NC.Operacion(Integer.parseInt(this.txtMonto.getText()));
        met.NuevoMovNoCliente(met.TomarFecha(), NC.getUsuario(), "TR", Integer.parseInt(this.txtMonto.getText()), Admin.getSaldoCajero());
        met.LimpiarCajas(txtCbu, txtMonto);
        int resp = met.Confirmacion("¿Desea realizar otra operacion?", "DEPOSITAR");
        if (resp != 0) {
    ...
    private void btnVolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVolverActionPerformed
        ...
        JFNoCliente Fcli = new JFNoCliente();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFNoClienteTransf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFNoClienteTransf().setVisible(true);
            }
        });
    }
